#
#  Be sure to run `pod spec lint SwiftClient.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SwiftClient"
  spec.version      = "1.5.0"
  spec.summary      = "Swift SDK for TelemetryDeck, a privacy-first analytics service for apps."
  ...
  spec.author             = { "TelemetryDeck" => "info@telemetrydeck.com" }
  # Or just: spec.author    = "TelemetryDeck"
  # spec.authors            = { "TelemetryDeck" => "info@telemetrydeck.com" }
  # spec.social_media_url   = "https://twitter.com/TelemetryDeck"
